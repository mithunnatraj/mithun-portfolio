...
export default function Hero() {
  ...
  return (
    <section id="about" className="scroll-mt-24 w-full flex flex-col md:flex-row items-center justify-between gap-4 md:gap-12 relative">
      <div className={`flex-1 transition-all duration-1000 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
        ...
        <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight mb-1.5 md:mb-4 leading-tight text-center md:text-left">
          Hi, I'm <br />
        ...
        <h2 className="text-xl md:text-2xl lg:text-3xl text-gray-300 font-semibold mb-2 md:mb-6 text-center md:text-left">
          Junior QA Engineer
        </h2>
