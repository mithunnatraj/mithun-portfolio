...
export default function Hero() {
  ...
  return (
    <section id="about" className="scroll-mt-24 w-full min-h-[calc(100vh-120px)] md:min-h-[85vh] flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 relative pt-2 md:pt-10">
