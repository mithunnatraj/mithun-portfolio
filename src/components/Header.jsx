    ...
    <header className="fixed top-0 w-full z-50 glass border-b border-[var(--color-dark-border)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="text-lg sm:text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500 whitespace-nowrap shrink-0 max-w-[160px] sm:max-w-none truncate sm:overflow-visible">
            Mithun Kumar N
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-3 shrink-0 ml-2">
            ...
            <a href="https://www.salesforce.com/trailblazer/mkumarn2" target="_blank" rel="noopener noreferrer" className="p-2 sm:px-4 sm:py-2 rounded-lg bg-blue-600/20 text-blue-400 border border-blue-500/30 hover:bg-blue-600 hover:text-white text-sm font-semibold transition-colors flex items-center gap-1.5 sm:gap-2">
