...
export default function Hero() {
  ...
  return (
    <section id="about" className="scroll-mt-24 w-full min-h-[85vh] md:min-h-[90vh] flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 relative pt-2 md:pt-10">
      <div className={`flex-1 transition-all duration-1000 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
        ...
        <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight mb-4 md:mb-6 leading-tight text-center md:text-left">
          Hi, I'm <br />
        ...
        <h2 className="text-xl md:text-2xl lg:text-3xl text-gray-300 font-semibold mb-4 md:mb-8 text-center md:text-left">
          Junior QA Engineer
        </h2>
        ...
        <div className="flex flex-col sm:flex-row flex-wrap gap-4 w-full sm:w-auto">
          ...
          <a href="https://www.salesforce.com/trailblazer/mkumarn2" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto px-8 py-3.5 rounded-xl border border-gray-600 hover:border-blue-400 hover:text-blue-400 hover:bg-blue-500/10 hover:scale-105 text-white font-bold transition-all flex items-center justify-center gap-2 group hover:shadow-[0_0_15px_rgba(59,130,246,0.3)]">
